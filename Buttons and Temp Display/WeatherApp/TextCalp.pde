...
String title, quit;
float currentTempToronto, currentTempVancouver, currentTempLondon;
String nameTor, nameVanc, nameLND;

void textSetup() {
  titleFont = createFont ("Harrington", height); // //Must also Tools / Create Font / Find Font / Do Not Press "OK"
  title = "Abdullahi Weather App";
  titleWidth = width * 1/2;
  titleHeight = height * 1/10;
  quit = "X";
  //apiCurrentDateCall, varaible to print to Canvas
  currentTempTor = tempToronto;
  currentTempVanc = tempVancouver;
  currentTempLND = tempLondon;

  nameTor = nameToronto;
  nameVanc = nameVancouver;
  nameLND = nameLondon;
